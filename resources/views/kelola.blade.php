...
<table class="wp-list-table widefat fixed striped posts">
	...
	<tr id="post-1" class="iedit author-self level-0 post-1 type-post status-publish format-standard hentry category-uncategorized">
		...
		<strong>{{ $anggota->nama }}</strong>
			...
			<a href="{{URL::to('/edit')}}/{{ $anggota->NRP }}" title="Edit this item">Edit</a> | </span>
			<span class="trash"><a class="submitdelete" title="Move this item to the Trash" href="{{URL::to('/hapus')}}/{{ $anggota->NRP }}">Hapus</a> | </span>
			<span class="view"><a href="{{URL::to('/lihat')}}/{{ $anggota->NRP }}" title="View “Hello world!”" rel="permalink">Lihat</a></span>
		</div>
