...
<link rel="stylesheet" href="{{asset('assets/css/anggota/load-styles.css')}}" type="text/css" media="all">
<link rel="stylesheet" id="open-sans-css" href="{{asset('assets/css/anggota/css.css')}}" type="text/css" media="all">
<link rel="stylesheet" id="thickbox-css" href="{{asset('assets/css/anggota/thickbox.css')}}" type="text/css" media="all">
<!--[if lte IE 7]>
<link rel='stylesheet' id='ie-css'  href='#/css/ie.min.css?ver=4.3.3' type='text/css' media='all' />
<![endif]-->
<link rel="stylesheet" id="tie-style-css" href="{{asset('assets/css/anggota/style.css')}}" type="text/css" media="all">
<link rel="stylesheet" id="tie-fonts-css" href="{{asset('assets/css/anggota/fonts.css')}}" type="text/css" media="all">
		<script type="text/javascript">
...
<script type="text/javascript" src="{{asset('assets/js/anggota/load-scripts_002.php')}}"></script>
<!--[if lt IE 8]>
<script type='text/javascript' src='http://localhost/ahapedia/wp-includes/js/json2.min.js?ver=2011-02-23'></script>
<![endif]-->
<script type="text/javascript" src="{{asset('assets/js/anggota/tie.js')}}"></script>
<script type="text/javascript">
/* <![CDATA[ */
...
<script type="text/javascript" src="{{asset('assets/js/anggota/quicktags.js')}}"></script>
...
<ul id="adminmenu">
	...
	<a href="{{URL::to('/anggota')}}" class="wp-first-item wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-top-first menu-icon-dashboard menu-top-last"><div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-dashboard"><br></div><div class="wp-menu-name">Dashboard</div></a>
		<ul class="wp-submenu wp-submenu-wrap">
			<li class="wp-submenu-head" aria-hidden="true">Dashboard</li>
			<li class="wp-first-item current"><a href="{{URL::to('/anggota')}}" class="wp-first-item current">Home</a></li>
	...
	<a href="{{URL::to('/editProfil')}}" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-users" aria-haspopup="true">
	...
	<a href="{{URL::to('/pilihGenre')}}" class="wp-has-submenu wp-not-current-submenu open-if-no-js menu-top menu-icon-post menu-top-first" aria-haspopup="true">
	...
	<a href="{{URL::to('/hasilLatihan')}}" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-tie_slider" aria-haspopup="true">
...
<div id="wpcontent">
	...
	<div id="wpadminbar" class="">
		...
		<ul>
			...
			<li id="wp-admin-bar-logout"><a class="ab-item" href="{{URL::to('/logout')}}">Log Out</a>		</li></ul></div>		
			</li>
		</ul>			
		</div>
...
<script type="text/javascript" src="{{asset('assets/js/anggota/load-scripts.php')}}"></script>
