...
<link rel="stylesheet" href="{{asset('assets/css/admin/load-styles.css')}}" type="text/css" media="all">
<link rel="stylesheet" id="open-sans-css" href="{{asset('assets/css/admin/css.css')}}" type="text/css" media="all">
<link rel="stylesheet" id="thickbox-css" href="{{asset('assets/css/admin/thickbox.css')}}" type="text/css" media="all">
<!--[if lte IE 7]>
<link rel='stylesheet' id='ie-css'  href='#/css/ie.min.css?ver=4.3.3' type='text/css' media='all' />
<![endif]-->
<link rel="stylesheet" id="tie-style-css" href="{{asset('assets/css/admin/style.css')}}" type="text/css" media="all">
<link rel="stylesheet" id="tie-fonts-css" href="{{asset('assets/css/admin/fonts.css')}}" type="text/css" media="all">
		<script type="text/javascript">
...
<script type="text/javascript" src="{{asset('assets/js/admin/load-scripts_002.php')}}"></script>
<!--[if lt IE 8]>
<script type='text/javascript' src='http://localhost/ahapedia/wp-includes/js/json2.min.js?ver=2011-02-23'></script>
<![endif]-->
<script type="text/javascript" src="{{asset('assets/js/admin/tie.js')}}"></script>
<script type="text/javascript">
/* <![CDATA[ */
...
<ul id="adminmenu">
	...
	<a href="#" class="wp-first-item wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-top-first menu-icon-dashboard menu-top-last"><div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-dashboard"><br></div><div class="wp-menu-name">Dashboard</div></a>
		<ul class="wp-submenu wp-submenu-wrap">
			...
			<li class="wp-first-item current"><a href="{{URL::to('/admin')}}" class="wp-first-item current">Home</a></li>
	...
	<a href="{{URL::to('/kelola')}}" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-users" aria-haspopup="true">
	...
	<a href="{{URL::to('/validasi')}}" class="wp-has-submenu wp-not-current-submenu open-if-no-js menu-top menu-icon-post menu-top-first" aria-haspopup="true">
	...
	<a href="{{URL::to('/createJadwal')}}" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-tie_slider menu-icon-post" aria-haspopup="true">
	...
	<li class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-page" id="menu-pages">
		<a href="{{URL::to('/penilaian')}}" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-page" aria-haspopup="true">
...
<script type="text/javascript" src="{{asset('assets/js/admin/load-scripts.php')}}"></script>
