...
<table class="wp-list-table widefat fixed striped posts">
	...
	<tr>
		...
		<span>Alamat</span><span class="sorting-indicator"></span></th>
			</tr>
	</thead>
	...
	<tr id="post-1" class="iedit author-self level-0 post-1 type-post status-publish format-standard hentry category-uncategorized">
		...
		<strong><?php echo e($anggota->nama); ?></strong>
			...
			<a href="<?php echo e(URL::to('/edit')); ?>/<?php echo e($anggota->NRP); ?>" title="Edit this item">Edit</a> | </span>
			<span class="trash"><a class="submitdelete" title="Move this item to the Trash" href="<?php echo e(URL::to('/hapus')); ?>/<?php echo e($anggota->NRP); ?>">Hapus</a> | </span>
			<span class="view"><a href="<?php echo e(URL::to('/lihat')); ?>/<?php echo e($anggota->NRP); ?>" title="View “Hello world!”" rel="permalink">Lihat</a></span>
		</div>
		<button type="button" class="toggle-row">
		<span class="screen-reader-text">Show more details</span></button>
	</td>
	<td class="author column-author" data-colname="Author"><?php echo e($anggota->NRP); ?></td>
		<td class="categories column-categories" data-colname="Categories">
			<?php echo e($anggota->jurusan); ?>

		</td>
		<td class="tags column-tags" data-colname="Tags">
			<span aria-hidden="false"><?php echo e($anggota->telepon); ?></span>
		</td>
		
		<td class="date column-date" data-colname="Date">
		<abbr title="2016/03/19 7:11:50 pm"><?php echo e($anggota->alamatasli); ?></abbr>
		</td>
