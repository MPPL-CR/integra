...
<link rel="stylesheet" href="<?php echo e(asset('assets/css/anggota/load-styles.css')); ?>" type="text/css" media="all">
<link rel="stylesheet" id="open-sans-css" href="<?php echo e(asset('assets/css/anggota/css.css')); ?>" type="text/css" media="all">
<link rel="stylesheet" id="thickbox-css" href="<?php echo e(asset('assets/css/anggota/thickbox.css')); ?>" type="text/css" media="all">
<!--[if lte IE 7]>
<link rel='stylesheet' id='ie-css'  href='#/css/ie.min.css?ver=4.3.3' type='text/css' media='all' />
<![endif]-->
<link rel="stylesheet" id="tie-style-css" href="<?php echo e(asset('assets/css/anggota/style.css')); ?>" type="text/css" media="all">
<link rel="stylesheet" id="tie-fonts-css" href="<?php echo e(asset('assets/css/anggota/fonts.css')); ?>" type="text/css" media="all">
		<script type="text/javascript">
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/anggota/load-scripts_002.php')); ?>"></script>
<!--[if lt IE 8]>
<script type='text/javascript' src='http://localhost/ahapedia/wp-includes/js/json2.min.js?ver=2011-02-23'></script>
<![endif]-->
<script type="text/javascript" src="<?php echo e(asset('assets/js/anggota/tie.js')); ?>"></script>
<script type="text/javascript">
/* <![CDATA[ */
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/anggota/quicktags.js')); ?>"></script>
...
<ul id="adminmenu">
	...
	<a href="<?php echo e(URL::to('/anggota')); ?>" class="wp-first-item wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-top-first menu-icon-dashboard menu-top-last"><div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-dashboard"><br></div><div class="wp-menu-name">Dashboard</div></a>
		<ul class="wp-submenu wp-submenu-wrap">
			<li class="wp-submenu-head" aria-hidden="true">Dashboard</li>
			<li class="wp-first-item current"><a href="<?php echo e(URL::to('/anggota')); ?>" class="wp-first-item current">Home</a></li>
	...
	<a href="<?php echo e(URL::to('/editProfil')); ?>" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-users" aria-haspopup="true">
	<div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-admin-users"><br></div>
	<div class="wp-menu-name">Edit Profil</div></a>
	<!--ul class="wp-submenu wp-submenu-wrap">
	...
	<a href="<?php echo e(URL::to('/pilihGenre')); ?>" class="wp-has-submenu wp-not-current-submenu open-if-no-js menu-top menu-icon-post menu-top-first" aria-haspopup="true">
	<div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-admin-post"><br></div>
	<div class="wp-menu-name">Pilih Genre Latihan</div></a>
		<!--ul class="wp-submenu wp-submenu-wrap">
			<li class="wp-submenu-head" aria-hidden="true">Pilih Genre Latihan</li>
			<li class="wp-first-item"><a href="#/edit.php" class="wp-first-item">dd</a></li>
			
		</ul-->
	</li>
	<li class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-tie_slider" id="menu-posts-tie_slider">
	<a href="<?php echo e(URL::to('/hasilLatihan')); ?>" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-tie_slider" aria-haspopup="true">
	...
	<div class="wp-menu-name">Hasil Latihan</div></a>
		<!--ul class="wp-submenu wp-submenu-wrap"><li class="wp-submenu-head" aria-hidden="true">Lihat</li>
...
<div id="wpcontent">
	...
	<div id="wpadminbar" class="">
		...
		<ul>
			<li id="wp-admin-bar-my-account" class="menupop with-avatar"><a class="ab-item" aria-haspopup="true" href="#/profile.php"><?php echo Session::get('Admin'); ?><img alt="" src="Dashboard_files/839c3c6b536c04b32c125e7d51f5cecd.jpg" srcset="http://2.gravatar.com/avatar/839c3c6b536c04b32c125e7d51f5cecd?s=52&amp;d=mm&amp;r=g 2x" class="avatar avatar-26 photo" height="26" width="26"></a><div class="ab-sub-wrapper"><ul id="wp-admin-bar-user-actions" class="ab-submenu">
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/anggota/load-scripts.php')); ?>"></script>
