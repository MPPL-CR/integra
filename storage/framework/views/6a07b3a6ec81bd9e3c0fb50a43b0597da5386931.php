...
<table class="wp-list-table widefat fixed striped posts">
	...
	<tr id="post-1" class="iedit author-self level-0 post-1 type-post status-publish format-standard hentry category-uncategorized">
		...
		<strong><?php echo e($anggota->nama); ?></strong>
			...
			<a href="<?php echo e(URL::to('/konfirmasi')); ?>/<?php echo e($anggota->ID); ?>" title="Edit this item">Konfirmasi</a> | </span>
			<span class="trash"><a class="submitdelete" title="Move this item to the Trash" href="<?php echo e(URL::to('/hapus')); ?>/<?php echo e($anggota->ID); ?>">Hapus</a> </span>
	...
	<td class="author column-author" data-colname="Author"><?php echo e($anggota->NRP); ?></td>
		...
		<td class="author column-author" data-colname="Author"><?php echo e($anggota->statusbayar); ?></td>
