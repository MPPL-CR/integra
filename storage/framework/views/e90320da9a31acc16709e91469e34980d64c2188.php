...
<?php $i=1; ?>
	...
	<td class="author column-author" data-colname="Author">5113100043</td>
		<td class="categories column-categories" data-colname="Categories">
			<?php echo e($anggota->genre); ?>

		</td>
		<td class="tags column-tags" data-colname="Tags">
			<span aria-hidden="false"><?php echo e($anggota->tanggal); ?></span>
		</td>
		<td class="tags column-tags" data-colname="Tags">
			<span aria-hidden="false"><?php echo e($anggota->tahapan); ?></span>
		</td>
		
		
		<td class="date column-date" data-colname="Date">
		<abbr title="2016/03/19 7:11:50 pm"><?php echo e($anggota->nilai); ?></abbr>
		</td>
		<td class="date column-date" data-colname="Date">
		<abbr title="2016/03/19 7:11:50 pm"><?php echo e($anggota->catatan); ?></abbr>
		</td>
